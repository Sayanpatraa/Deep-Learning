...
def main():
    ...
    train_tf = T.Compose([
        T.Resize((256, 256)),
        T.RandomResizedCrop(224, scale=(0.7, 1.0)),  # More aggressive crop
        T.RandomHorizontalFlip(),
        T.RandomRotation(20),  # Increase from 15 to 20
        T.ColorJitter(brightness=0.3, contrast=0.3, saturation=0.3, hue=0.1),  # Stronger + add hue
        T.RandomAffine(degrees=0, translate=(0.1, 0.1)),  # NEW: Random shifts
        T.ToTensor(),
